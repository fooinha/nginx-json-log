...
/* configuration */
rd_kafka_conf_t * kasha_kafka_conf_new(ngx_pool_t *pool);
rd_kafka_conf_res_t kasha_kafka_conf_set_int(ngx_pool_t *pool, rd_kafka_conf_t *conf, const char * key, intmax_t value);
rd_kafka_conf_res_t kasha_kafka_conf_set_str(ngx_pool_t *pool, rd_kafka_conf_t *conf, const char * key, ngx_str_t *str);

/* handler */
rd_kafka_t * kasha_kafka_producer_new(ngx_pool_t *pool, rd_kafka_conf_t *);
...
/* topic confifuration */
rd_kafka_topic_conf_t * kasha_kafka_topic_conf_new(ngx_pool_t* pool);
